...
<div class="row">
  <div class="col-lg-4">
    ...
    <p>
  <strong>User CRUD App</strong> is a simple web-based application developed as a practice project to demonstrate basic CRUD (Create, Read, Update, Delete) operations on user data.
</p>
<ul style="color: #fff; padding-left: 20px;">
  <li>Add new users with username and email</li>
